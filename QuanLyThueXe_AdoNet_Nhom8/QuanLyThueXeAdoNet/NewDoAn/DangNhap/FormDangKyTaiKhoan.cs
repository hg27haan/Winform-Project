...
namespace NewDoAn
{
    public partial class FormDangKyTaiKhoan : MaterialForm
    {
        ...
        ThongTinDangNhap tTDN = new ThongTinDangNhap();
        ...
        {
            if (tKDAO.KiemTraTaiKhoanTrungNhau(txtCMND.Text, txtTenDangNhap.Text) == true)
            {
            ...
            else
            {
                ...
                {
                    tTCN = new ThongTinCaNhan(txtHoVaTen.Text, txtCMND.Text, txtSDT.Text, txtDiaChi.Text);
                    tTDN = new ThongTinDangNhap(tTCN, txtTenDangNhap.Text, txtMatKhau.Text);
                    tKDAO.DangKyTaiKhoan(tTDN);
                    flag = true;
                }
                else
                {
